    ...
    <div v-for="p in projects">
      <div class="py-6 px-3">
        <div class="rounded-lg bg-white shadow-xl overflow-hidden">
          <img :src="'/storage/' + getCrop(p.image)" :alt="p.heading" class="rounded-lg">
          <div class="p-4">
          ...
          <div class="flex p-4 border-t border-gray-300 text-gray-700">
            ...
            <div class="flex-1 inline-flex items-center">
              <a :href="getUrl(p.slug)">
                <button
                    class="rounded-lg hover:underline gradient text-white font-bold my-1 py-3 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                  {{ $ml.get('readmore') }}
                </button>
              </a>
            </div>
