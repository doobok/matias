{{-- <a href="#"> --}}
  <div class="rounded-lg w-full sm:w-1/2 lg:w-1/3 p-2 h-64 hover:border-4 border-gray-700 gradient--hovered">
    <a href="{{ $solution->url ? route('page', $solution->url) : '#' }}" class="rounded-lg w-full h-full shadow-xl flex flex-wrap justify-left items-left content-end bg-cover bg-center"
