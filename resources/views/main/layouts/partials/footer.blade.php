        ...
        <div class="w-full flex flex-col md:flex-row py-16">
            <div class="flex-1 mb-6 text-black flex justify-center">
                <a class="no-underline hover:no-underline" href="{{route('mainpage')}}">
                    <img src="/logo/white.svg" alt="{{config('app.name')}}" height="80" width="100">
                </a>
            </div>
            <div class="flex-1">
            ...
            <span class="ml-1 mr-4 flex">
              ...
              {{-- telegram --}}
              <svg class="mx-1" title="Telegram" viewBox="0 0 24 24" width="20px" height="20px" fill="currentColor"
                ...
                <ul class="list-reset mb-6">
                    <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                        <a href="{{route('mappage')}}"
                           class="no-underline hover:underline text-white">{{__('site.sitemap')}}</a>
                    </li>
                    <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                        <a href="{{route('page', 'policy')}}"
                           class="no-underline hover:underline text-white">{{__('site.policy')}}</a>
                    </li>
                </ul>
            </div>
        </div>
        <p class="text-center text-gray-200 pb-2">{{ __('site.copyright') }} © {{ config('app.name') }} 2021
            - {{ date("Y") }}</p>
    </div>
</footer>
