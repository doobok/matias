    ...
    <div class="flex flex-wrap flex-col-reverse sm:flex-row">
      ...
      <div class="w-full sm:w-1/2 p-6 mt-6">
        <div class="align-middle">
          ...
          <ul class="list-disc text-lg font-bold text-gray-600 mt-4 ml-8">
            <li class="my-1">{{__('mainpage.why-we1')}}</li>
            <li class="my-1">{{__('mainpage.why-we2')}}</li>
            <li class="my-1">{{__('mainpage.why-we3')}}</li>
            <li class="my-1">{{__('mainpage.why-we4')}}</li>
          </ul>
          <div class="flex items-center justify-center">

            <phone-btn title="{{__('mainpage.get-consultation')}}" color="gradient text-white"></phone-btn>
